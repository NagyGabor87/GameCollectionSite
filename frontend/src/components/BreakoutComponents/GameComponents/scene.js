...
import { LEVELS } from '../GameCore/levels'
import { MOVEMENT, getNewGameState, getGameStateFromLevel } from '../GameCore/core'
...
export default (containerSize) => {
    ...
    useEffect(() => {
        ...
        const timerId = window.setInterval(tick, UPDATE_EVERY)
